...
export function LocationPinIcon(props: SVGProps<HTMLOrSVGElement>) {
    return (
        <>
            <svg
            ...
            >
                <path
                    ...
                    stroke="#221b38"
                    fill="#C4B6FF"
                    d="M12.01 2H12H11.99C8.28999 2 5.11999 4.95 4.99999 8.51C4.96999 9.6 5.28999 10.79 5.73999 11.71C5.73999 11.71 5.74999 11.72 5.74999 11.73L11.12 21.49C11.3 21.83 11.65 22 12 22C12.35 22 12.7 21.83 12.88 21.49L18.25 11.73C18.25 11.72 18.26 11.71 18.26 11.71C18.71 10.79 19.03 9.6 19 8.51C18.88 4.95 15.71 2 12.01 2Z"
                />
                <path
                    strokeLinejoin="round"
                    strokeLinecap="round"
