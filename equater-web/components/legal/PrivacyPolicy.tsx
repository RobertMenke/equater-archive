...
export function PrivacyPolicy() {
    return (
        <div className={'theme-dark text-primary p-8 pl-8 pr-8 md:pl-64 md:pr-64'}>
            <h1 className={'text-xl text-primary'}>Privacy Policy</h1>
            <p className={'text-secondary pb-4'}>Last updated: August 29, 2020</p>
            ...
            <h1 className={'text-xl text-primary'}>Interpretation and Definitions</h1>
            <h2 className={'text-lg text-primary'}>Interpretation</h2>
            <p className={'text-secondary pb-4'}>
            ...
            <h2 className={'text-lg text-primary'}>Definitions</h2>
            <p className={'text-secondary pb-4'}>For the purposes of this Privacy Policy:</p>
            <ul className={'list-disc pl-8'}>
                ...
                <li>
                    <p className={'text-secondary pb-4'}>
                        ...
                        You on any electronic device, named Equater
                    </p>
                </li>
                <li>
                    <p className={'text-secondary pb-4'}>
                ...
                <li>
                    <p className={'text-secondary pb-4'}>
                        ...
                        &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Equater Inc.
                    </p>
                </li>
                <li>
                    <p className={'text-secondary pb-4'}>
                ...
                <li>
                    <p className={'text-secondary pb-4'}>
                        <strong>Website</strong> refers to Equater, accessible from{' '}
                        <a href="https://www.equater.app" rel="noreferrer" target="_blank">
                            https://www.equater.app
                        </a>
                    </p>
                </li>
                <li>
            ...
            <h1 className={'text-xl text-primary'}>Collecting and Using Your Personal Data</h1>
            <h2 className={'text-lg text-primary'}>Types of Data Collected</h2>
            <h3 className={'text-md text-primary'}>Personal Data</h3>
            <p className={'text-secondary pb-4'}>
            ...
            <ul className={'list-disc pl-8'}>
                <li>
                    <p className={'text-secondary pb-4'}>Email address</p>
                </li>
                <li>
                    <p className={'text-secondary pb-4'}>First name and last name</p>
                </li>
                <li>
                    <p className={'text-secondary pb-4'}>Address, State, Province, ZIP/Postal code, City</p>
                </li>
                <li>
                    <p className={'text-secondary pb-4'}>Usage Data</p>
                </li>
            </ul>
            <h3 className={'text-md text-primary'}>Usage Data</h3>
            <p className={'text-secondary pb-4'}>Usage Data is collected automatically when using the Service.</p>
            <p className={'text-secondary pb-4'}>
            ...
            <h3 className={'text-md text-primary'}>Information Collected while Using the Application</h3>
            <p className={'text-secondary pb-4'}>
            ...
            <h3 className={'text-md text-primary'}>Tracking Technologies and Cookies</h3>
            <p className={'text-secondary pb-4'}>
            ...
            <ul className={'list-disc pl-8'}>
                <li>
                    ...
                    <p className={'text-secondary pb-4'}>Type: Session Cookies</p>
                    <p className={'text-secondary pb-4'}>Administered by: Us</p>
                    <p className={'text-secondary pb-4'}>
                ...
                <li>
                    ...
                    <p className={'text-secondary pb-4'}>Type: Persistent Cookies</p>
                    <p className={'text-secondary pb-4'}>Administered by: Us</p>
                    <p className={'text-secondary pb-4'}>
                ...
                <li>
                    ...
                    <p className={'text-secondary pb-4'}>Type: Persistent Cookies</p>
                    <p className={'text-secondary pb-4'}>Administered by: Third-Parties</p>
                    <p className={'text-secondary pb-4'}>
            ...
            <h2 className={'text-lg text-primary'}>Use of Your Personal Data</h2>
            <p className={'text-secondary pb-4'}>The Company may use Personal Data for the following purposes:</p>
            <ul className={'list-disc pl-8'}>
                <li>
            ...
            <p className={'text-secondary pb-4'}>We may share your personal information in the following situations:</p>
            <ul className={'list-disc pl-8'}>
                <li>
            ...
            <h2 className={'text-lg text-primary'}>Retention of Your Personal Data</h2>
            <p className={'text-secondary pb-4'}>
            ...
            <h2 className={'text-lg text-primary'}>Transfer of Your Personal Data</h2>
            <p className={'text-secondary pb-4'}>
            ...
            <h2 className={'text-lg text-primary'}>Disclosure of Your Personal Data</h2>
            <h3 className={'text-md text-primary'}>Business Transactions</h3>
            <p className={'text-secondary pb-4'}>
            ...
            <h3 className={'text-md text-primary'}>Law enforcement</h3>
            <p className={'text-secondary pb-4'}>
            ...
            <h3 className={'text-md text-primary'}>Other legal requirements</h3>
            <p className={'text-secondary pb-4'}>
            ...
            <h2 className={'text-lg text-primary'}>Security of Your Personal Data</h2>
            <p className={'text-secondary pb-4'}>
            ...
            <h1 className={'text-xl text-primary'}>Detailed Information on the Processing of Your Personal Data</h1>
            <p className={'text-secondary pb-4'}>
                Service Providers have access to Your Personal Data only to perform their tasks on Our behalf and are
                obligated not to disclose or use it for any other purpose.
            </p>
            <h2 className={'text-lg text-primary'}>Analytics</h2>
            <p className={'text-secondary pb-4'}>
            ...
            <ul className={'list-disc pl-8'}>
                ...
                <li>
                    ...
                    <p className={'text-secondary pb-4'}>Firebase is an analytics service provided by Google Inc.</p>
                    <p className={'text-secondary pb-4'}>
                    ...
                    <p className={'text-secondary pb-4 break-words'}>
            ...
            <h2 className={'text-lg text-primary'}>Email Marketing</h2>
            <p className={'text-secondary pb-4'}>
            ...
            <ul className={'list-disc pl-8'}>
                <li>
                    ...
                    <p className={'text-secondary pb-4'}>
                        ...
                        <a href="https://sendgrid.com/policies/privacy-2016/" rel="noreferrer" target="_blank">
                            https://sendgrid.com/policies/privacy-2016/
                        </a>
                    </p>
                </li>
            </ul>
            <h2 className={'text-lg text-primary'}>Payments</h2>
            <p className={'text-secondary pb-4'}>
            ...
            <ul className={'list-disc pl-8'}>
                <li>
                    <p className={'text-secondary pb-4'}>
                        <strong>Dwolla</strong>
                    </p>
                    <p className={'text-secondary pb-4'}>
                        Their Privacy Policy can be viewed at{' '}
                        <a href="https://www.dwolla.com/legal/privacy/" rel="noreferrer" target="_blank">
                            https://www.dwolla.com/legal/privacy/
                        </a>
                    </p>
                </li>
            </ul>
            <h1 className={'text-xl text-primary'}>CCPA Privacy</h1>
            <h2 className={'text-lg text-primary'}>Your Rights under the CCPA</h2>
            <p className={'text-secondary pb-4'}>
            ...
            <ul className={'list-disc pl-8'}>
                <li>
                    <strong>The right to notice.</strong> You must be properly notified which categories of Personal
                    Data are being collected and the purposes for which the Personal Data is being used.
                </li>
                <li>
                    <strong>The right to access / the right to request.</strong> The CCPA permits You to request and
                ...
                <li>
                    <strong>The right to say no to the sale of Personal Data.</strong> You also have the right to ask
                    the Company not to sell Your Personal Data to third parties. You can submit such a request by
                    visiting our &quot;Do Not Sell My Personal Information&quot; section or web page.
                </li>
                <li>
                    <strong>The right to know about Your Personal Data.</strong> You have the right to request and
                ...
                <li>
                    <strong>The right to delete Personal Data.</strong> You also have the right to request the deletion
            ...
            <h2 className={'text-lg text-primary'}>Exercising Your CCPA Data Protection Rights</h2>
            <p className={'text-secondary pb-4'}>
            ...
            <h2 className={'text-lg text-primary'}>Do Not Sell My Personal Information</h2>
            <p className={'text-secondary pb-4'}>
            ...
            <h3 className={'text-md text-primary'}>Website</h3>
            <p className={'text-secondary pb-4'}>
            ...
            <h3 className={'text-md text-primary'}>Mobile Devices</h3>
            <p className={'text-secondary pb-4'}>
            ...
            <p className={'text-secondary pb-4'}>Our Service does not respond to Do Not Track signals.</p>
            <p className={'text-secondary pb-4'}>
            ...
            <h1 className={'text-xl text-primary'}>Links to Other Websites</h1>
            <p className={'text-secondary pb-4'}>
            ...
            <h1 className={'text-xl text-primary'}>Changes to this Privacy Policy</h1>
            <p className={'text-secondary pb-4'}>
            ...
            <ul className={'list-disc pl-8'}>
                <li>By email: support@equater.app</li>
            </ul>
        </div>
    )
}
